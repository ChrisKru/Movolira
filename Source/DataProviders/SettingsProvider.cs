...
namespace Movolira.DataProviders {
	public class SettingsProvider {
		private readonly int[] THEME_RIDS = {
			Resource.Style.AppThemeLightEmerald,
			Resource.Style.AppThemeLightBlue,
			Resource.Style.AppThemeLightViolet,
			Resource.Style.AppThemeLightAmaranth,
			Resource.Style.AppThemeLightFirebrick,
			Resource.Style.AppThemeLightTangerine,
		};
